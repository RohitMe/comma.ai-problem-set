...
# Define a procedure is_leap_baby that takes 3 inputs: day, month and year and returns True if the date is a leap day (Feb 29 in a valid leap year) and False otherwise.

# A year that is a multiple of 4 is a leap year unless the year is divisible by 100 but not a multiple of 400 (so, 1900 is not a leap year but 2000 and 2004 are).
...
# The function 'output' prints one of two statements based on whether the is_leap_baby function returned True or False.
